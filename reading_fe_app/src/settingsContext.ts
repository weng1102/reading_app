...
export const SettingsCloner = (settings: ISettings): ISettings => {
  return {
    speech: SpeechSettingsInitializer(
      settings.speech.recitationMode,
      settings.speech.lang,
      settings.speech.locale,
      settings.speech.gender,
      settings.speech.pitch,
      settings.speech.rate,
      settings.speech.volume,
      settings.speech.selectedVoiceIndex
    ),
    listen: ListenSettingsInitializer(
      settings.listen.timeout,
      settings.listen.listeningInterval,
      settings.listen.notificationMode,
      settings.listen.sentenceNotification,
      settings.listen.sectionNotification
    )
  };
};
...
export class CSpeechSettings {
  ...
  setRecitationMode(recitationMode: RecitationMode) {
