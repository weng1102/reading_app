...
import { ParseNode } from "./baseClasses";
import { SectionNodeMarkdownClassMap } from "./parsesections";
...
//   transform(): number;
// }
export type ITerminalNode = ITerminalContent & IParseNode; // & IContentMethods & ITerminalMethods;
abstract class AbstractTerminalNode extends ParseNode implements ITerminalNode {
  ...
  // }
  transform() {
    this.logger.diagnostic(`AbstractTerminalNode: transform()`);
    return 0;
  }
}
...
//   }
// }
class TerminalNode_WORD extends AbstractTerminalNode implements ITerminalNode {
  constructor(parent) {
    super(parent);
...
class TerminalNode_NUMBER extends AbstractTerminalNode
  implements ITerminalNode {
  constructor(parent) {
    super(parent);
  }
}
class TerminalNode_PUNCTUATION extends AbstractTerminalNode
  implements ITerminalNode {
  constructor(parent) {
    super(parent);
  }
...
class TerminalNode_MLTAG extends AbstractTerminalNode implements ITerminalNode {
  constructor(parent) {
    super(parent);
    //    this.type = TerminalNodeEnumType.MLTAG;
  }
}
class TerminalNode_MLTAG_END extends AbstractTerminalNode
  implements ITerminalNode {
  constructor(parent) {
    super(parent);
...
class TerminalNode_MLTAG_SELFCLOSING extends AbstractTerminalNode
  implements ITerminalNode {
  constructor(parent) {
    super(parent);
...
class TerminalNode_WHITESPACE extends AbstractTerminalNode
  implements ITerminalNode {
  constructor(parent) {
    super(parent);
...
abstract class TerminalNode_MLTAG_ extends AbstractTerminalNode
  implements ITerminalNode {
  //  markupLabel: string;
  constructor(parent) {
    super(parent);
