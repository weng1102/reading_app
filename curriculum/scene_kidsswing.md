[[page: Kids Playing Narrative and Progression,, Wen,, Scenes, /]]
# Kids Playing Scene Narrative
...
#### Visiting a public park
[[image-entry: Scene narratives, left, 40%, shadow-box rounded-box]]
![Kids Swinging](scene_kidsswing.jpg)
[[fillin: gridInOrder, true, 1, true,, Recite the following prompts about the image:, grid, 6, insert, true, true, true, true, true, false]]
A1. Visiting a public park
  A1. The [_family=(noun)_] [_goes=(verb)_] [_to=(preposition)_] the [_park=(noun)_].
  A1. The community [_library=(noun)_] [_is=(verb)_] [_in=(preposition)_] the [_background=(noun)_].
...
![Kids Playing](scene_kidsswing.jpg, scene_kidsswing_overlayA.png)
A1. Visiting a public park
  A1. [button: model, , , , css attributes/] The family goes to the park.
  A1. [button: model, , , , css attributes/] The community library is in the background.
  A1. [button: model, , , , css attributes/] A flagpole is sitting in front of the building.
  A1. [button: model, , , , css attributes/] The play area is surrounded by green grass.
[[/image-entry]]
#### Swinging back and forth
[[image-entry: Scene narratives, left, 40%, shadow-box rounded-box]]
![Kids Playing](scene_kidsswing.jpg, scene_kidsswing_overlayB.png)
B1. Swinging back and forth
  B1. [button: model, , , , css attributes/] The oldest daughter is riding on the swing.
  B1. [button: model, , , , css attributes/] She is wearing pink overalls and matching shoes.
  B1. [button: model, , , , css attributes/] Her father is pushing her.
[[/image-entry]]
#### Sliding down
[[image-entry: Scene narratives, left, 40%, shadow-box rounded-box]]
![Kids Playing](scene_kidsswing.jpg, scene_kidsswing_overlayC.png)
C1. Sliding down
  C1. [button: model, , , , css attributes/] The little girl is going down a blue slide.
  C1. [button: model, , , , css attributes/] She is raising her arms up while sliding.
  C1. [button: model, , , , css attributes/] She is wearing a floral top and purple shorts.
[[/image-entry]]
#### Climbing up
[[image-entry: Scene narratives, left, 40%, shadow-box rounded-box]]
![Kids Playing](scene_kidsswing.jpg, scene_kidsswing_overlayD.png)
D1. Climbing up the slide
  D1. [button: model, , , , css attributes/] The toddler is climbing the slide ladder.
  D1. [button: model, , , , css attributes/] He is wearing a blue shirt.
  D1. [button: model, , , , css attributes/] His mother is helping him get up the ladder.
  D1. [button: model, , , , css attributes/] She is wearing a lavender top.
[[/image-entry]]
### Scene (labeled)
[[image-entry: Scene narratives, left, 40%, shadow-box rounded-box]]
![Kids Playing](scene_kidsswing.jpg,scene_kidsswing_overlay.png)
A1. Visiting a public park
  ...
  A1. The play area is surrounded by green grass.
A1. Swinging back and forth
  A1. [button: model, , , , css attributes/] The oldest daughter is riding on the swing.
  A1. [button: model, , , , css attributes/] She is wearing pink overalls and matching shoes.
  A1. [button: model, , , , css attributes/] Her father is pushing her.
A1. Sliding down
  A1. [button: model, , , , css attributes/] The little girl is going down a blue slide.
  A1. [button: model, , , , css attributes/] She is holding her arms up while sliding.
  A1. [button: model, , , , css attributes/] She is wearing a floral top and purple shorts.
A1. Climbing the up
  A1. [button: model, , , , css attributes/] The toddler is climbing the slide ladder.
  A1. [button: model, , , , css attributes/] He is wearing a blue shirt.
  A1. [button: model, , , , css attributes/] His mother is helping him get up the ladder.
  A1. [button: model, , , , css attributes/] She is wearing a lavender top.
[[/image-entry]]
### Scene and Subscenes (unlabeled)
[[image-entry: Scene narratives, left, 40%, shadow-box rounded-box]]
![Kids Playing](scene_kidsswing.jpg)
