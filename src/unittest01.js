...
const { Logger, MyDate } = require("../src/utilities(migrated).js");
...
const uttransformsectionout = path.join(
  utresultDir,
  "ut01transform_sections.json"
);
...
logger.adorn(
  "* S E N T E N C E   T R A N S F O R M E R ***",
  false,
  false,
  false,
  false
...
for (let secIdx = 0; secIdx < ut_sentences01.sections.length; secIdx++) {
  ...
  for (
    ...
    unitTestSuccessful = sentenceNode.unitTest(
      actual,
      input.expected.transformer
    );
    logger.info(
      testSentLabel + (unitTestSuccessful ? "PASSED" : "FAILED"),
      false,
...
logger.adorn(
  "* S E C T I O N  T R A N S F O R M E R ******",
  false,
  false,
  false,
  false
...
for (let secIdx = 0; secIdx < ut_sentences01.sections.length; secIdx++) {
  ...
  logger.adorn(
    testSectionLabel + (unitTestSuccessful ? "PASSED" : "FAILED"),
    false,
    false,
    false,
    false
...
logger.info(
  "Transformer01 SECTION Overall total: " +
    passCount +
    "/" +
    totalCount +
    " PASSED",
...
logger.info(
  testSectionLabel + ": Browse " + htmloutput,
  false,
  false,
  false,
  false
